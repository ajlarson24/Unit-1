...
//This is the start of the debugging script to add the objects as text in our webpage
function debugAjax(){
	
    //creating the data variable we will use later
	var myData;
	
    //initial fetch request, grabs the data from the GEOjson file
	fetch("data/MegaCities.geojson")
        //defining the conversion callback function
		.then(function(response){
            //converting the GEOjson file to a usable format
			return response.json();
		})
        //defining a callback function
		.then(function(response){
            //creating a variable to assign the data to
			myData = response

            //this was to check that the data was being brought into the program correctly
            //console.log(myData)

            //this displays the data as text on the webpage
